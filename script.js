$(window).resize(function(){
 if($(window).width() < 300){
   $('div').css({width:"100%",height:"130px",margin:"0px"});
   ...
   $(socials).hide();     
   $(socials2).show();
   $(imgfooter).css({marginLeft:"0 auto",width:"40px",height:"40px"});
   $('footer').css({height:"100px",borderRadius:"0"});
   $('.container-fluid').css({margin:"0px"});
     ...
     $('p').css({fontSize:"15px"});
     $(logo).css({position:"relative",margin:"0 auto",width:"120px",height:"120px"});
     $('header').css({display:"block",textAlign:"center",borderRadius:"0"});
     $('footer').css({height:"180px",borderRadius:"0"});
     $(imgfooter).css({marginLeft:"0 auto",width:"80px",height:"80px"});
     $(geogame).hide();
     $(socials).hide();
     $(socials2).show();
     $(copyright).css({marginTop:"5px"});
